...
<link href="/Public/Admin/css/a.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="block1">
  <div class="allMenu fl"> <a href="" title="" style="font-size:15px;" class="index current">首页</a>
    ...
    <!--</dd>-->
    <!--</dl>-->
        <!--<?php if(is_array($cats)): foreach($cats as $key=>$cat): ?>-->
            <!--<?php if($cat[lv] == 0): ?>-->
                <!--<dl>-->
                    <!--<dt><a href="<?php echo U('Home/Cat/Cat',array('cat_id'=>$cat[cat_id]));?>"><?php echo ($cat[cat_name]); ?></a></dt>-->
                    <!--<dd class="clearfix">-->
                        <!--<?php if(is_array($cats)): foreach($cats as $key=>$s): ?>-->
                            <!--<?php if($cat[cat_id] == $s[parent_id]): ?>-->
                                <!--<p class=""><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$s[cat_id]));?>" title="CDMA手机" class="txtdot"><?php echo ($s["cat_name"]); ?></a></p>-->
                            <!--<?php endif; ?>-->
            ...
            <!--<?php endif; ?>-->
        <!--<?php endforeach; endif; ?>-->
        <?php if(is_array($cat)): foreach($cat as $key=>$c): if($c[parent_id] == 0): ?><dl>
                    <dt><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$c[cat_id]));?>"><?php echo ($c[cat_name]); ?></a></dt>
                    <dd class="clearfix">
                    <?php if(is_array($cat)): foreach($cat as $key=>$c1): if($c[cat_id] == $c1[parent_id]): ?><p><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$c1[cat_id]));?>" title="CDMA手机" class="txtdot"><?php echo ($c1[cat_name]); ?></a><?php endif; endforeach; endif; ?>
    ...
    <form name="compareForm" action="" method="post">
        <div class="clearfix grid">
            <?php if(is_array($goodslist)): foreach($goodslist as $key=>$g): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
                <div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$g['goods_id']));?>"><img src="/Public/<?php echo ($g[goods_img]); ?>" alt="<?php echo ($g[goods_name]); ?>"></a></div>
