...
<h1>
<span class="action-span"><a href="<?php echo U('goodslist');?>">商品列表</a></span>
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="<?php echo U('admin/goods/goodsedit');?>" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">商品分类：</td>
              <td>
            <!--<select name="cat_id"  ><option value="0">请选择...</option>-->
                <!--<?php if(is_array($cat)): foreach($cat as $k=>$vo): ?>-->
        ...
        <div class="button-div">
                    <input type="hidden" value="<?php echo ($list['goods_id']); ?>" name="goods_id">
