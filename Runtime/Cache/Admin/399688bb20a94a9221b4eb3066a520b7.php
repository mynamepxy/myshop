...
.explode {
  background: url(/PublicAdmin/menu_minus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.collapse {
  background: url(/PublicAdmin/menu_plus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.menu-item {
  background: url(/PublicAdmin/menu_arrow.gif) no-repeat 0px 3px;
  font-weight: normal;
}
#help-title {
  font-size: 14px;
...
<body>
<div id="tabbar-div">
<p><span style="float:right; padding: 3px 5px;" ><a href="#"><img id="toggleImg" src="/PublicAdmin/menu_minus.gif" width="9" height="9" border="0" alt="闭合" /></a></span>
